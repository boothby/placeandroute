...
def msat_push_minimize(e, term, lower, upper):
    return _mathsat.msat_push_minimize(e, term, lower, upper)
msat_push_minimize = _mathsat.msat_push_minimize

def msat_push_maximize(e, term, lower, upper):
    return _mathsat.msat_push_maximize(e, term, lower, upper)
msat_push_maximize = _mathsat.msat_push_maximize

def msat_push_minmax(e, len, terms, lower, upper):
    return _mathsat.msat_push_minmax(e, len, terms, lower, upper)
msat_push_minmax = _mathsat.msat_push_minmax

def msat_push_maxmin(e, len, terms, lower, upper):
    return _mathsat.msat_push_maxmin(e, len, terms, lower, upper)
...
def msat_objective_value_is_strict(e, o, i):
    return _mathsat.msat_objective_value_is_strict(e, o, i)
msat_objective_value_is_strict = _mathsat.msat_objective_value_is_strict

def msat_objective_value_term(e, o, i):
    return _mathsat.msat_objective_value_term(e, o, i)
